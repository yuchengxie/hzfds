...
var app={
	...
	toggleAside:function(){
		$('.aside>li:nth-child(1) ul,.aside>li:nth-child(2) ul,.aside>li:nth-child(3) ul,.aside>li:nth-child(4) ul,.aside>li:nth-child(5) ul,.aside>li:nth-child(6) ul,.aside>li:nth-child(7) ul').hide();
